...
type UserServiceClient interface {
	...
	GetUsersByID(ctx context.Context, in *UserIDsRequest, opts ...grpc.CallOption) (*UsersResponse, error)
	SearchUsers(ctx context.Context, in *User, opts ...grpc.CallOption) (*UsersResponse, error)
}
...
func (c *userServiceClient) GetUsersByID(ctx context.Context, in *UserIDsRequest, opts ...grpc.CallOption) (*UsersResponse, error) {
	out := new(UsersResponse)
	err := c.cc.Invoke(ctx, UserService_GetUsersByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) SearchUsers(ctx context.Context, in *User, opts ...grpc.CallOption) (*UsersResponse, error) {
	out := new(UsersResponse)
...
type UserServiceServer interface {
	...
	GetUsersByID(context.Context, *UserIDsRequest) (*UsersResponse, error)
	SearchUsers(context.Context, *User) (*UsersResponse, error)
...
func (UnimplementedUserServiceServer) GetUsersByID(context.Context, *UserIDsRequest) (*UsersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsersByID not implemented")
}
func (UnimplementedUserServiceServer) SearchUsers(context.Context, *User) (*UsersResponse, error) {
...
func _UserService_GetUsersByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUsersByID(ctx, req.(*UserIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_SearchUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SearchUsers(ctx, req.(*User))
	}
	return interceptor(ctx, in, info, handler)
}
